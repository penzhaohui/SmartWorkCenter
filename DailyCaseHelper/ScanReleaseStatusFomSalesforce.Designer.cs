...
{
    partial class ScanReleaseStatusFomSalesforce
    {
        /// <summary>
    ...
    "elow box and then click \"Sync with JIRA and SF\" button.";
            ...
            this.txtCaseIDList.Size = new System.Drawing.Size(1247, 73);
            ...
            this.btnSendSummaryReport.Click += new System.EventHandler(this.btnSendSummaryReport_Click);
            // 
    ...
    "y for release";
            // 
            // ScanReleaseStatusFomSalesforce
            // 
            ...
            this.Name = "ScanReleaseStatusFomSalesforce";
            this.Text = "Scan Release Status Fom Salesforce";
